...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        self.layer4 = Linear(128, 128)
        self.layer5 = Linear(128, 64)
        self.layer6 = Linear(64, 1)
    ...
    def forward(self, x):
        ...
        h4 = relu(self.layer4(h3))
        h5 = relu(self.layer5(h4))
        return self.layer6(h5)
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        self.first_layer = Linear(input_size, 64)
        self.second_layer = Linear(64, output_size) # hidden layers, need matrix 
    ...
    def forward(self, x):
        ...
        """
        """ YOUR CODE HERE """
        forward_result = self.second_layer(relu(self.first_layer(x)))
